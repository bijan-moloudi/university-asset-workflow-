 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ir.sain.university.service.impl.StudentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ir.sain.university.service.impl.StudentLocalServiceImpl
 * @generated
 */
public abstract class StudentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StudentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ir.sain.university.service.StudentLocalServiceUtil</code>.
	 */
	...
	public void addCourseStudent(long courseId, long studentId) {
		coursePersistence.addStudent(courseId, studentId);
	}
	...
	public void addCourseStudent(long courseId, Student student) {
		coursePersistence.addStudent(courseId, student);
	}
	...
	public void addCourseStudents(long courseId, long[] studentIds) {
		coursePersistence.addStudents(courseId, studentIds);
	}
	...
	public void addCourseStudents(long courseId, List<Student> students) {
		coursePersistence.addStudents(courseId, students);
	}
	...
	public void clearCourseStudents(long courseId) {
		coursePersistence.clearStudents(courseId);
	}
	...
	public void deleteCourseStudent(long courseId, long studentId) {
		coursePersistence.removeStudent(courseId, studentId);
	}
	...
	public void deleteCourseStudent(long courseId, Student student) {
		coursePersistence.removeStudent(courseId, student);
	}
	...
	public void deleteCourseStudents(long courseId, long[] studentIds) {
		coursePersistence.removeStudents(courseId, studentIds);
	}
	...
	public void deleteCourseStudents(long courseId, List<Student> students) {
		coursePersistence.removeStudents(courseId, students);
	}
	...
	public long[] getCoursePrimaryKeys(long studentId) {
		return studentPersistence.getCoursePrimaryKeys(studentId);
	}
	...
	public List<Student> getCourseStudents(long courseId) {
		return studentPersistence.getCourseStudents(courseId);
	}
	...
	public List<Student> getCourseStudents(long courseId, int start, int end) {
		return studentPersistence.getCourseStudents(courseId, start, end);
	}
	...
	public List<Student> getCourseStudents(
		...
		return studentPersistence.getCourseStudents(
	...
	public int getCourseStudentsCount(long courseId) {
		return coursePersistence.getStudentsSize(courseId);
	}
	...
	public boolean hasCourseStudent(long courseId, long studentId) {
		return coursePersistence.containsStudent(courseId, studentId);
	}
	...
	public boolean hasCourseStudents(long courseId) {
		return coursePersistence.containsStudents(courseId);
	}
	...
	public void setCourseStudents(long courseId, long[] studentIds) {
		coursePersistence.setStudents(courseId, studentIds);
	}
