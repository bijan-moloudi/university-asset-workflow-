...
import ir.sain.university.service.CourseLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ir.sain.university.service.impl.CourseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ir.sain.university.service.impl.CourseLocalServiceImpl
 * @generated
 */
public abstract class CourseLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CourseLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ir.sain.university.service.CourseLocalServiceUtil</code>.
	 */
	...
	public void addStudentCourse(long studentId, long courseId) {
		studentPersistence.addCourse(studentId, courseId);
	}
	...
	public void addStudentCourse(long studentId, Course course) {
		studentPersistence.addCourse(studentId, course);
	}
	...
	public void addStudentCourses(long studentId, long[] courseIds) {
		studentPersistence.addCourses(studentId, courseIds);
	}
	...
	public void addStudentCourses(long studentId, List<Course> courses) {
		studentPersistence.addCourses(studentId, courses);
	}
	...
	public void clearStudentCourses(long studentId) {
		studentPersistence.clearCourses(studentId);
	}
	...
	public void deleteStudentCourse(long studentId, long courseId) {
		studentPersistence.removeCourse(studentId, courseId);
	}
	...
	public void deleteStudentCourse(long studentId, Course course) {
		studentPersistence.removeCourse(studentId, course);
	}
	...
	public void deleteStudentCourses(long studentId, long[] courseIds) {
		studentPersistence.removeCourses(studentId, courseIds);
	}
	...
	public void deleteStudentCourses(long studentId, List<Course> courses) {
		studentPersistence.removeCourses(studentId, courses);
	}
	...
	public long[] getStudentPrimaryKeys(long courseId) {
		return coursePersistence.getStudentPrimaryKeys(courseId);
	}
	...
	public List<Course> getStudentCourses(long studentId) {
		return coursePersistence.getStudentCourses(studentId);
	}
	...
	public List<Course> getStudentCourses(long studentId, int start, int end) {
		return coursePersistence.getStudentCourses(studentId, start, end);
	}
	...
	public List<Course> getStudentCourses(
		...
		return coursePersistence.getStudentCourses(
	...
	public int getStudentCoursesCount(long studentId) {
		return studentPersistence.getCoursesSize(studentId);
	}
	...
	public boolean hasStudentCourse(long studentId, long courseId) {
		return studentPersistence.containsCourse(studentId, courseId);
	}
	...
	public boolean hasStudentCourses(long studentId) {
		return studentPersistence.containsCourses(studentId);
	}
	...
	public void setStudentCourses(long studentId, long[] courseIds) {
		studentPersistence.setCourses(studentId, courseIds);
	}
