...
public interface StudentPersistence extends BasePersistence<Student> {
	 ...
	 * @return the matching students
	 */
	public java.util.List<Student> findByG_G(long groupId, long universityId);
	 ...
	 * @return the range of matching students
	 */
	public java.util.List<Student> findByG_G(
	 ...
	 */
	public java.util.List<Student> filterFindByG_G(
		long groupId, long universityId);
	 ...
	 */
	public void addCourse(long pk, ir.sain.university.model.Course course);
	...
	public void addCourses(
		long pk, java.util.List<ir.sain.university.model.Course> courses);
	 ...
	 * @param course the course
	 */
	public void removeCourse(long pk, ir.sain.university.model.Course course);
