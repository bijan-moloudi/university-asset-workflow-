...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws ir.sain.university.exception.NoSuchStudentException {
	 ...
	 * @return the matching students
	 */
	public static List<Student> findByG_G(long groupId, long universityId) {
	 ...
	 * @return the range of matching students
	 */
	public static List<Student> findByG_G(
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByG_G_First(
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByG_G_First(
		long groupId, long universityId,
		OrderByComparator<Student> orderByComparator) {
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByG_G_Last(
			long groupId, long universityId,
			OrderByComparator<Student> orderByComparator)
		throws ir.sain.university.exception.NoSuchStudentException {
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByG_G_Last(
		long groupId, long universityId,
		OrderByComparator<Student> orderByComparator) {
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student[] findByG_G_PrevAndNext(
	 ...
	 */
	public static List<Student> filterFindByG_G(
		long groupId, long universityId) {

		return getPersistence().filterFindByG_G(groupId, universityId);
	}
	...
	public static List<Student> filterFindByG_G(
		...
		return getPersistence().filterFindByG_G(
			groupId, universityId, start, end);
	}
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student[] filterFindByG_G_PrevAndNext(
			long studentId, long groupId, long universityId,
			OrderByComparator<Student> orderByComparator)
		throws ir.sain.university.exception.NoSuchStudentException {
	 ...
	 */
	public static int filterCountByG_G(long groupId, long universityId) {
		return getPersistence().filterCountByG_G(groupId, universityId);
	}
	...
	public static void addCourse(
		long pk, ir.sain.university.model.Course course) {
	...
	public static void addCourses(
		long pk, List<ir.sain.university.model.Course> courses) {
